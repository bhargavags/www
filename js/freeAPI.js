...
*/
var _FreeApiKey = '2phcdj83e8wxf3dx4hdqrgzc';
...
function jsonP(url, callback) {
    $.ajax({
        ...
        error: function (e) {
            alert("We have detected that you do not have an internet connection. PPC Weather Watch requires an internet connection.");
